...
public class Datenbankzugriffe extends JFrame implements WindowListener, ActionListener {
	...
	private void initializeComponents() {
		...
		miBeenden = SwingUtil.createMenuItem(menuDatei, null, SwingUtil.MenuItemType.ITEM_PLAIN, this, "Beenden", null,
				'e', "Programm beenden");
		...
		miPostleitzahlenImportieren = SwingUtil.createMenuItem(menuExtras, null, SwingUtil.MenuItemType.ITEM_PLAIN,
				this, "Postleitzahlen importieren...", null, 'i', null);
	...
	private void readFile(String Dateiname) {
		...
		try (Scanner scanner = new Scanner(new FileInputStream(Dateiname))) {
			...
			while (scanner.hasNextLine()) {
				...
				signsread += zeile.length() + "\n\r".length();
				result = (int) (signsread * 100 / length);
			...
			JOptionPane.showMessageDialog(this, "Fehler beim Einlesen der Datei " + Dateiname + ": " + ex.getMessage(),
