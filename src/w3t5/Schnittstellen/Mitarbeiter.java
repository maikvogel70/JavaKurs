...
public class Mitarbeiter extends AbstractMitarbeiter implements IPrintable, IPrintSetup, Comparable<Mitarbeiter> {
	...
	/*
	 * Mit Enumerations (Enums) wurde in Java 1.5 ein lang vermisstes Element der
	 * Programmiersprache nachgereicht, welches in anderen Sprachen schon lange
	 * vorhanden ist. Durch Enums ist es möglich auf einfachste und sichere Art und
	 * Weise Aufzählungen zu realisieren, die früher über statische Konstante
