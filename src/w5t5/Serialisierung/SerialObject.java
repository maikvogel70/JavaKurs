...
public class SerialObject implements Serializable {
	...
	/*
	 * Ausschluss von Attributen mit transient Es kommt vor, dass Objekte temporäre
	 * Daten speichern, die beim Serialisieren nicht hinausgeschrieben werden zu
	 * brauchen, weil man sie beim Deserialisieren effizienter neu initialisieren
	 * kann. Solche Attribute kann man als transient deklarieren.
	 * 
	 */
	...
	public String toString() {
		return "TestObjekt: " + this.Name + " " + String.valueOf(this.Ganzzahl) + ", Temp1: " + temp1 + ", Temp2: "
				+ temp2 + ", Temp3: " + temp3;
	}
