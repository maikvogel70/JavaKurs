...
public class ListBoxComboBox extends JFrame
		implements ListSelectionListener, ItemListener, ActionListener, KeyListener, FocusListener {
	...
	private void initializeComponents() {
		...
		// und einen KeyListener zur Überprüfung der Eingabe auf die editierbare
		// Komponente zuweisen.
