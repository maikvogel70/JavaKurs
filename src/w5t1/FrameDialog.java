...
public class FrameDialog extends JFrame implements ActionListener, ItemListener, WindowListener {
	...
	private void dateiLesen(String Dateiname) {
		...
		JOptionPane.showMessageDialog(this,
				...
				"Lesen zeilenweise mit Scanner", JOptionPane.INFORMATION_MESSAGE);
	...
	private void dateiLesenPuffer(String Dateiname) {
		...
		JOptionPane.showMessageDialog(this,
				"Dauer: " + NumberFormat.getInstance().format(ende - start) + " Millisekunden.", "Lesen mit Puffer",
	...
	private void dateiLesenPuffer1(String Dateiname) {
		...
		if (file.length() > Integer.MAX_VALUE) {
			// JOptionPane.showMessageDialog(this, "Die Datei ist zu groß um mit dieser
			// Methode eingelesen werden zu können", "E/A Fehler",
			// JOptionPane.ERROR_MESSAGE);
			// return;
		...
		JOptionPane.showMessageDialog(this,
				"Dauer: " + NumberFormat.getInstance().format(ende - start) + " Millisekunden.", "Lesen mit Puffer1",
				JOptionPane.INFORMATION_MESSAGE);
	...
	private void dateiLesenTextAreaRead(String Dateiname) {
		...
		JOptionPane.showMessageDialog(this,
				"Dauer: " + NumberFormat.getInstance().format(ende - start) + " Millisekunden.",
				"Lesen mit TextAreaRead", JOptionPane.INFORMATION_MESSAGE);

		textArea.requestFocusInWindow();

	}

	// Gint 'true' zurück, wenn das Programm beendet werden soll
